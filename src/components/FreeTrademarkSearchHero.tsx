      ...
      <div className="relative mx-auto w-full max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        <div className="space-y-5">
          ...
          <h1 className="text-3xl font-semibold leading-tight text-[#212121] sm:text-4xl lg:text-[3.1rem] lg:leading-[1.1] font-[var(--font-heading)]">
            Check Your <span className="text-[#6c4cb1]">Brand Name's </span> Availability Before You File
          </h1>
          <p className="mx-auto max-w-3xl text-sm leading-relaxed text-[#333333] sm:text-lg font-[var(--font-body)]">
            Before you invest time and money into building your brand, it's crucial to know if your desired name is available. Our free trademark search provides a fast and easy way to check the U.S. Patent and Trademark Office (USPTO) database for identical registered marks. This essential first step helps you avoid obvious conflicts and proceed with greater confidence.
