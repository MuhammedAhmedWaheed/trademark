  ...
  return (
    <section className="relative overflow-hidden bg-black py-16 sm:py-20">
      ...
      <div className="relative mx-auto flex w-full max-w-4xl flex-col items-center gap-6 px-4 text-center sm:px-6">
        ...
        <Link
          href="/contact"
          className="inline-flex items-center justify-center rounded-full bg-white px-7 py-3 text-sm font-semibold text-black transition duration-300 hover:bg-[#F5F5F5] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white font-[var(--font-heading)]"
        >
          Get Started
        </Link>
      </div>
